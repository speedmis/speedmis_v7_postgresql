...
function pageLoad() {
	...
	global $misSessionIsAdmin, $misSessionUserId;
...
function makeLink(userid,username) {
	...
	url = "addLogic_treat.php?RealPid=<?=$real_pid?>&userid="+userid+"&username="+username+"&expireday="+expireday;
...
function save_writeAfter() {
    ...
    global $base_root, $real_pid, $misJoinPid, $logicPid, $parent_idx, $full_siteID;
...
function addLogic_treat() {
	...
	global $misSessionUserId,$full_site,$DbPW;
