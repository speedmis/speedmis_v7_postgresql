...
function viewLogic_afterLoad_continue() {
	...
	$('a.btn_into_top_img').click( function() {
		...
		url = "addLogic_treat.php?RealPid=<?=$RealPid?>&top_img="+img_name+'&idx='+document.getElementById('idx').value;
...
$created_by = onlyOnereturnSql("select id from users where email='$MisSession_UserID';");
if($created_by=='') {
    $created_by = '3';
}
$sql = $sql . " 
