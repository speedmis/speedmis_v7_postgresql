...
function add_storage(car_parts_id) {
	url = "addLogic_treat.php?RealPid=<?=$RealPid?>&car_parts_id="+car_parts_id+"&question=add_storage";
	ajax_url_return(url);
	$("#grid").data("kendoGrid").dataSource.read();
}	
function remove_storage(car_parts_id,idx) {
	url = "addLogic_treat.php?RealPid=<?=$RealPid?>&car_parts_id="+car_parts_id+"&idx="+idx+"&question=remove_storage";
	ajax_url_return(url);
	$("#grid").data("kendoGrid").dataSource.read();
}
