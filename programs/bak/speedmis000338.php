...
function pageLoad() {
	...
	global $misSessionUserId, $full_siteID, $actionFlag;
...
<?php
	...
	if($actionFlag=="modify") {
		...
		$cnt_allPush_member = 1*onlyOnereturnSql("select count(*) from MisGroup_Member where gidx=20 and userid='$misSessionUserId';");
