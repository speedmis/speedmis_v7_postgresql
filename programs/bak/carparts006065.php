...
function addLogic_treat() {
	...
	if($question=="move") {
		$sql = " select sortG01,sortG02,sortG03,sortG04,sortG05,sortG06,sortG07,sortG08,sortG09,sortG10,depth from mis_parts_cate where idx='$p_idx' ";
		$r = allreturnSql($sql);
		$depth = $r[0]['depth'];
		$sortG01 = $r[0]['sortG01'];
		$sortG02 = $r[0]['sortG02'];
		...
		$sql = " 
		update mis_parts_cate set sortG01='$sortG01',sortG02='$sortG02',sortG03='$sortG03',sortG04='$sortG04',sortG05='$sortG05' 
		...
		$sql = " 
		insert into mis_parts_cate (cate_name, upidx, sortG01, sortG02, sortG03, sortG04, sortG05, sortG06, sortG07, sortG08, sortG09, sortG10
		, depth, wdater) 
