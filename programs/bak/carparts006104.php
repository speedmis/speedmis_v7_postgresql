...
function misMenuList_change() {
	...
	global $MisSession_PositionCode, $flag, $list_check_hidden, $allFilter, $MisSession_UserID;
    ...
    "2029-12-25"
            ...
            foreach ($daterange as $date) {
                ...
                if (in_array($pdate, $all_holidays) || $dayOfWeek > 5) {
                    ...
                    insert into mis_holidays (hdate,wdater) values ('$pdate', '$MisSession_UserID');
                    ";
...
SELECT '$project_idx', pdate, 'Y', '$MisSession_UserID' -- is_checked와 wdater는 기본값 설정
FROM DateRange;
