...
///////////////////////////////////////////////
	if($RealPid=='speedmis001169') {
		...
		$search_index = array_search("yeollakcheo", array_column($result, 'alias_name'));
		$result[$search_index]["Grid_ListEdit"] = "Y";

		$search_index = array_search("bangmunggyeongnokodeu", array_column($result, 'alias_name'));
		$result[$search_index]["Grid_ListEdit"] = "Y";
	}


	//아래는 필드명 자체를 특정 값으로 변경하는 예제임
    //$result[$search_index]["db_table"] = "";
    //$result[$search_index]["db_field"] = "'.....'";
