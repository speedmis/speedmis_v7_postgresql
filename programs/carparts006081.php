...
JOIN v_parts_cate_tree_sortG03 AS vc
...
function addLogic_treat() {
	...
	if($question=="move") {
		$sql = " select sortG01,sortG02,sortG03,depth from parts_cate where idx='$p_idx' ";
		$r = allreturnSql($sql);
		$depth = $r[0]['depth'];
		$sortG01 = $r[0]['sortG01'];
		$sortG02 = $r[0]['sortG02'];
		...
		$sql = " 
		update parts_cate set sortG01='$sortG01',sortG02='$sortG02',sortG03='$sortG03'
		where idx='$p_idx';
		...
		$sql = " 
		insert into parts_cate (cate_name, upidx, sortG01, sortG02, sortG03
		, depth, wdater) 
