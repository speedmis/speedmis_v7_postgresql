...
function columns_templete(p_dataItem, p_aliasName) {
    ...
    if(p_aliasName=='widx') {
		var rValue = ' <a href="index.php?RealPid=' + p_dataItem['RealPid'] + '&idx=' + p_dataItem['widx'] + '&isMenuIn=auto" target="_blank" class="k-button">새창</a>';
		
		rValue = p_dataItem[p_aliasName]+rValue;
        return rValue;
    } else {
