...
function rowFunctionAfter_UserDefine(p_this) {
    ...
    "<a href=index.php?RealPid=" + p_this.RealPid + "&isMenuIn=Y target=_blank>[Go]</a>"+iif(p_this.menu_type=="01", "<a id='aid_" + p_this.idx + "' href=index.php?RealPid=speedmis000266&idx=" 
