...
function list_query() {
    ...
    if($app=='인쇄삭제') { 
		$appSql2 = " update parts_storage set print_request_time=null
...
function list_json_load() {
    ...
    global $base_root, $real_pid, $mis_join_pid, $logicPid, $parent_idx,$addParam;
    ...
    if($flag=='readResult' && $addParam=='print') { 
        ...
        if($count>0) {
			$idx = $p_data[0]['idx'];
			$url = "https://xn--or3b27p5mi.com/gadmin/?gubun=6052&sid=$idx";
...
";
			$appSql2 = " update parts_storage set print_request_time=null,print_response_time=NOW()
