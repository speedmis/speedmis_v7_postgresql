...
function scheduler_pageLoad() {
    ...
    //$filterField_sql = "select distinct m.wdater as 'value', (select top 1 mu.UserName from mis_users mu where m.wdater=mu.UniqueNum) as 'text' from mis_schedule_meeting m";
    $filterField_sql = "select kcode as 'value', kname as 'text', kname2 as 'color' from mis_common_data where RealCid<>ggcode and ggcode = 'rbk001063' ";
