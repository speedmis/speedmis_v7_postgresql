...
function list_query() {
    ...
    if($flag=='read') { 
        $countQuery = replace($countQuery, "parts_storage_mapping table_m"
, "parts_storage_mapping table_m
left outer join car_parts cp on cp.id=table_m.car_parts_id
left outer join v_parts_storage_tree table_storage_cate_idx on table_storage_cate_idx.idx = table_m.storage_cate_idx
");
