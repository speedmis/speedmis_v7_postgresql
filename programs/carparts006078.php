...
function addLogic_treat() {
	...
	if($question=="move") {
		$sql = " select sortG01,sortG02,sortG03,sortG04,sortG05,sortG06,sortG07,sortG08,sortG09,sortG10,depth from parts_storage where idx='$p_idx' ";
		$r = allreturnSql($sql);
		$depth = $r[0]['depth'];
		$sortG01 = $r[0]['sortG01'];
		$sortG02 = $r[0]['sortG02'];
		...
		$sql = " 
		update parts_storage set sortG01='$sortG01',sortG02='$sortG02',sortG03='$sortG03',sortG04='$sortG04',sortG05='$sortG05' 
		,sortG06='$sortG06',sortG07='$sortG07',sortG08='$sortG08',sortG09='$sortG09',sortG10='$sortG10'
		where idx='$p_idx';
		call parts_storage_ordering_proc();		-- 여기서 vv_parts_storage_tree 로 생성시킴
		";
		//echo $sql;
		execSql($sql);
		echo 'success';
		...
		,upidx,depth from parts_storage where idx='$p_idx' ";
		$r = allreturnSql($sql);
		...
		$sql = " 
		insert into parts_storage (storage_name, upidx, sortG01, sortG02, sortG03, sortG04, sortG05, sortG06, sortG07, sortG08, sortG09, sortG10
		, depth, wdater) 
